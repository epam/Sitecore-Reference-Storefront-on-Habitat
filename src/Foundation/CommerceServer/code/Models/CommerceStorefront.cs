namespace Sitecore.Foundation.CommerceServer.Models
{
    ...
    // TODO: Rename to CommerceHabitat.
    /// <summary>
    ...
    public class CommerceStorefront : SitecoreItemBase
    {
        ...
        /// </value>
        /// <exception cref="Sitecore.Foundation.CommerceServer.Exceptions.DefaultCurrencyNotSetException">The default currency must be set on the Home item of the Storefront.</exception>
        public virtual string DefaultCurrency
        {
            get
            {
                string linkedCurrency = this.HomeItem[Templates.CommerceStorefront.Fields.DefaultCurrency.ToString()];
