...
using System.Linq;
using System.Text;
using LineItem = CommerceServer.Core.Runtime.Orders.LineItem;
using OrderForm = CommerceServer.Core.Runtime.Orders.OrderForm;
using PurchaseOrder = CommerceServer.Core.Runtime.Orders.PurchaseOrder;

namespace Sitecore.Feature.Cart.Pipelines.Orders
{
    /// <summary>
