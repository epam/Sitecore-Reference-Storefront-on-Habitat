namespace Sitecore.Foundation.CommerceServer.Managers
{
    ...
    using Commerce.Connect.CommerceServer.Orders;
    using Commerce.Connect.CommerceServer.Orders.Models;
    using Commerce.Connect.CommerceServer.Orders.Pipelines;
    ...
    public class CartManager : ICartManager
    {
        ...
        /// </returns>
        public virtual ManagerResponse<CartResult, CommerceCart> GetCurrentCart([NotNull] CommerceStorefront storefront, [NotNull] IVisitorContext visitorContext, bool refresh = false)
        {
        ...
        /// </returns>
        public virtual ManagerResponse<CartResult, bool> UpdateCartCurrency([NotNull] CommerceStorefront storefront, [NotNull] IVisitorContext visitorContext, [NotNull] string currencyCode)
        {
        ...
        /// </returns>
        public virtual ManagerResponse<CartResult, bool> AddLineItemsToCart([NotNull] CommerceStorefront storefront, [NotNull] IVisitorContext visitorContext, IEnumerable<AddCartLineInputModel> inputModelList)
        {
            ...
            var addLinesResult = this._cartServiceProvider.AddCartLines(addLinesRequest);
        ...
        /// The manager response where the modified CommerceCart is returned in the Result.
        /// </returns>
        public virtual ManagerResponse<CartResult, CommerceCart> RemoveLineItemFromCart([NotNull] CommerceStorefront storefront, [NotNull] IVisitorContext visitorContext, [NotNull] string externalCartLineId)
        {
            ...
            var removeLinesResult = this._cartServiceProvider.RemoveCartLines(removeLinesRequest);
        ...
        /// The manager response where the modified CommerceCart is returned in the Result.
        /// </returns>
        public virtual ManagerResponse<CartResult, CommerceCart> ChangeLineQuantity([NotNull] CommerceStorefront storefront, [NotNull] IVisitorContext visitorContext, [NotNull] UpdateCartLineInputModel inputModel)
        {
            ...
            else if (cartLineToChange != null)
            {
                ...
                result = this._cartServiceProvider.UpdateCartLines(request);
            }
        ...
        /// The manager response where the modified CommerceCart is returned in the Result.
        /// </returns>
        public virtual ManagerResponse<AddPromoCodeResult, CommerceCart> AddPromoCodeToCart([NotNull] CommerceStorefront storefront, [NotNull] IVisitorContext visitorContext, string promoCode)
        {
            ...
            request.RefreshCart(true);
            result = ((CommerceCartServiceProvider)this._cartServiceProvider).AddPromoCode(request);
            if (result.Success && result.Cart != null)
            {
                cartCache.AddCartToCache(result.Cart as CommerceCart);
            }
        ...
        /// The manager response where the modified CommerceCart is returned in the Result.
        /// </returns>
        public virtual ManagerResponse<RemovePromoCodeResult, CommerceCart> RemovePromoCodeFromCart([NotNull] CommerceStorefront storefront, [NotNull] IVisitorContext visitorContext, string promoCode)
        {
            Assert.ArgumentNotNull(storefront, "storefront");
            Assert.ArgumentNotNull(visitorContext, "visitorContext");
            Assert.ArgumentNotNullOrEmpty(promoCode, "promoCode");
            ...
            result = ((CommerceCartServiceProvider)this._cartServiceProvider).RemovePromoCode(request);
            if (result.Success && result.Cart != null)
            {
                cartCache.AddCartToCache(result.Cart as CommerceCart);
            }
        ...
        public virtual ManagerResponse<CartResult, CommerceCart> AddPartyToCart([NotNull] CommerceStorefront storefront, [NotNull] IVisitorContext visitorContext, [NotNull] CommerceCart cart, [NotNull] CommerceParty party)
        {
            ...
            var result = this._cartServiceProvider.AddParties(request);
        ...
        /// the updated cart
        /// </returns>
        public virtual ManagerResponse<CartResult, CommerceCart> RemovePartiesFromCart([NotNull] CommerceStorefront storefront, [NotNull] IVisitorContext visitorContext, [NotNull] CommerceCart cart, [NotNull] List<Party> parties)
        {
            Assert.ArgumentNotNull(cart, "cart");
            Assert.ArgumentNotNull(parties, "parties");

            var request = new RemovePartiesRequest(cart, parties);
            var result = this._cartServiceProvider.RemoveParties(request);
        ...
        /// <param name="cart">The cart.</param>
        /// <returns>The manager response with a cart in the result.</returns>
        public virtual ManagerResponse<CartResult, CommerceCart> RemoveAllShippingParties([NotNull] CommerceStorefront storefront, [NotNull] IVisitorContext visitorContext, [NotNull] CommerceCart cart)
        {
            Assert.ArgumentNotNull(storefront, "storefront");
            Assert.ArgumentNotNull(visitorContext, "visitorContext");
            Assert.ArgumentNotNull(cart, "cart");
        ...
        /// <param name="cart">The cart.</param>
        /// <returns>The manager response with a cart in the result.</returns>
        public virtual ManagerResponse<CartResult, CommerceCart> RemoveAllBillingParties([NotNull] CommerceStorefront storefront, [NotNull] IVisitorContext visitorContext, [NotNull] CommerceCart cart)
        {
            Assert.ArgumentNotNull(storefront, "storefront");
            Assert.ArgumentNotNull(visitorContext, "visitorContext");
            Assert.ArgumentNotNull(cart, "cart");
        ...
        /// <param name="cart">The cart.</param>
        /// <returns>The manager response with a cart in the result.</returns>
        public virtual ManagerResponse<CartResult, CommerceCart> RemoveAllPaymentMethods([NotNull] CommerceStorefront storefront, [NotNull] IVisitorContext visitorContext, [NotNull] CommerceCart cart)
        {
            Assert.ArgumentNotNull(storefront, "storefront");
            Assert.ArgumentNotNull(visitorContext, "visitorContext");
            Assert.ArgumentNotNull(cart, "cart");
            ...
            if (cart.Payment != null && cart.Payment.Any())
            {
                ...
                var response = this._cartServiceProvider.RemovePaymentInfo(request);
        ...
        public virtual ManagerResponse<CartResult, CommerceCart> RemoveAllShippingMethods([NotNull] CommerceStorefront storefront, [NotNull] IVisitorContext visitorContext, [NotNull] CommerceCart cart)
        {
            Assert.ArgumentNotNull(storefront, "storefront");
            Assert.ArgumentNotNull(visitorContext, "visitorContext");
            Assert.ArgumentNotNull(cart, "cart");
            ...
            if (cart.Shipping != null && cart.Shipping.Any())
            {
                ...
                var response = this._cartServiceProvider.RemoveShippingInfo(request);
        ...
        /// the updated cart
        /// </returns>
        public virtual ManagerResponse<CartResult, CommerceCart> AddPaymentInfoToCart([NotNull] CommerceStorefront storefront, [NotNull] IVisitorContext visitorContext, [NotNull] CommerceCart cart, [NotNull] PaymentInfo info, [NotNull] CommerceParty party, bool refreshCart = false)
        {
            Assert.ArgumentNotNull(cart, "cart");
            ...
            var result = this._cartServiceProvider.AddPaymentInfo(request);
        ...
        public virtual ManagerResponse<CartResult, CommerceCart> UpdateCart([NotNull] CommerceStorefront storefront, [NotNull] IVisitorContext visitorContext, [NotNull] CommerceCart cart, [NotNull] CommerceCart cartChanges)
        {
            Assert.ArgumentNotNull(storefront, "storefront");
            Assert.ArgumentNotNull(visitorContext, "visitorContext");
            Assert.ArgumentNotNull(cart, "cart");
        ...
        protected virtual CartResult LoadCartByName(string shopName, string cartName, string userName, bool refreshCart = false)
        {
            ...
            var result = this._cartServiceProvider.LoadCart(request);
        ...
        protected virtual CartResult RemoveCartLines(Cart cart, IEnumerable<CartLine> cartLines, bool refreshCart = false)
        {
            ...
            request.RefreshCart(refreshCart);
            var result = this._cartServiceProvider.RemoveCartLines(request);
        ...
        /// <returns>the updated cart</returns>
        protected virtual CartResult UpdatePartiesInCart([NotNull] CommerceStorefront storefront, [NotNull] IVisitorContext visitorContext, [NotNull] CommerceCart cart, [NotNull] List<CommerceParty> parties)
        {
            Assert.ArgumentNotNull(cart, "cart");
            Assert.ArgumentNotNull(parties, "parties");

            var request = new UpdatePartiesRequest(cart, parties.Cast<Party>().ToList());
            var result = this._cartServiceProvider.UpdateParties(request);
        ...
        /// the updated cart
        /// </returns>
        protected virtual CartResult RemovePaymentInfoFromCart([NotNull] CommerceStorefront storefront, [NotNull] IVisitorContext visitorContext, [NotNull] CommerceCart cart, [NotNull] List<PaymentInfo> info, bool refreshCart = false)
        {
            Assert.ArgumentNotNull(cart, "cart");
            Assert.ArgumentNotNull(info, "info");
            ...
            request.RefreshCart(refreshCart);
            var result = this._cartServiceProvider.RemovePaymentInfo(request);
        ...
        protected virtual AddShippingInfoResult AddShippingInfoToCart([NotNull] CommerceCart cart, [NotNull] ShippingOptionType orderShippingPreferenceType, [NotNull] IEnumerable<ShippingInfo> shipments)
        {
            ...
            request.RefreshCart(true);
            var result = this._cartServiceProvider.AddShippingInfo(request);
        ...
        protected virtual void UpdateStockInformation([NotNull] CommerceStorefront storefront, [NotNull] IVisitorContext visitorContext, [NotNull] CommerceCartLine cartLine, [NotNull] string catalogName)
        {
            ...
            var stockInfoResult = this._inventoryManager.GetStockInformation(storefront, products, StockDetailsLevel.Status).ServiceProviderResult;
            ...
            if (stockInfo != null && stockInfo.Status != null)
            {
                ...
                {
                    var preOrderableResult = this._inventoryManager.GetPreOrderableInformation(storefront, products).ServiceProviderResult;
                ...
                {
                    var backOrderableResult = this._inventoryManager.GetBackOrderableInformation(storefront, products).ServiceProviderResult;
        ...
        /// </returns>
        protected virtual AddPartiesResult SetShippingAddresses(CommerceStorefront storefront, IVisitorContext visitorContext, CommerceCart cart, List<PartyInputModelItem> shippingAddresses, List<EmailParty> emailPartyList)
        {
            ...
            var addPartiesResponse = this._cartServiceProvider.AddParties(addPartiesRequest);
